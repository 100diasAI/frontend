...
const ResetPassword = () => {
    ...
    const ChangePassword = async (e) => {
        e.preventDefault()
        try {
            const {data} = await axios.post(`https://backend-xsy3.onrender.com/user/olvide-password/${token}`,
    ...
    useEffect(() => {
        const checkToken = async () => {
            const {data} = await axios.get(`https://backend-xsy3.onrender.com/user/olvide-password/${token}`)
